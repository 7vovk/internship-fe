...
import TablesWrapper from "@/components/companies/table/tables-wrapper";
import UsersScoreChart from "@/components/companies/charts/users-score-chart";
import UserAllQuizzesScoreChart from "@/components/companies/charts/user-all-quizzes-score-chart";
...
export default async function UserProfilePage() {
  ...
  return (
    <PageTemplate translator={tProfile}>
      ...
      <TablesWrapper />
      <UsersScoreChart />
      <UserAllQuizzesScoreChart userId={currentUser!.id} />
    </PageTemplate>
  );
}
